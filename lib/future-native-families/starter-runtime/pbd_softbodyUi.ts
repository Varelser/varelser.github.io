...
export const pbdSoftbodyUiSections: readonly FutureNativeUiSectionSpec[] = [
  {
    id: 'topology',
    title: 'Topology',
    controls: [
      { key: 'width', label: 'Width', kind: 'slider', min: 3, max: 20, step: 1 },
      { key: 'height', label: 'Height', kind: 'slider', min: 3, max: 20, step: 1 },
      { key: 'spacing', label: 'Spacing', kind: 'slider', min: 0.03, max: 0.2, step: 0.005 },
      { key: 'anchorMode', label: 'Anchor mode', kind: 'select', options: ['none', 'top-edge', 'top-corners', 'core'] },
  ...
  },
  {
    ...
    controls: [
      ...
      { key: 'volumePreservation', label: 'Volume preserve', kind: 'slider', min: 0, max: 1.2, step: 0.01 },
      { key: 'clusterStiffness', label: 'Cluster shape', kind: 'slider', min: 0, max: 1, step: 0.01 },
      { key: 'shellTension', label: 'Shell tension', kind: 'slider', min: 0, max: 1, step: 0.01 },
  ...
  },
  {
    ...
    controls: [
      ...
      { key: 'obstacleFieldRadius', label: 'Obstacle radius', kind: 'slider', min: 0, max: 0.4, step: 0.005 },
      { key: 'obstacleFieldStrength', label: 'Obstacle strength', kind: 'slider', min: 0, max: 1, step: 0.01 },
