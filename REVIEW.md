- 2026-04-06: phase5 real-export readiness は esbuild 依存の host 差で再生成停止していたため、manifest / readiness report を pure JS 生成へ置換。baseline fixture を追加して plumbing を固定したが、Intel Mac 実ブラウザ capture 自体は未同梱。
