# Volumetric Light/Shadow Coupling family closure patch blueprint

- patchId: family-closure-volumetric-light-shadow-coupling
...
- overlayPath: family-closure-patches-2026-04-06/family-closure-volumetric-light-shadow-coupling.md
...
- volumetric-light-shadow-coupling evidence note md
- volumetric-light-shadow-coupling verify checklist md
- volumetric-light-shadow-coupling closure gap memo md
...
```md
- 対象: volumetric-light-shadow-coupling
- 種別: patch
- 触った範囲: 
- 触っていない幹線: 
- 実行 verify: 
