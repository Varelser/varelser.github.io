...
- `docs/archive/phase5-real-export-readiness-report.json` — phase5 real-export fixture の readiness scaffold report
- `docs/archive/phase5-proof-input/real-export-capture-notes.md` — 実ブラウザ capture の差し替え手順と入力ノート
